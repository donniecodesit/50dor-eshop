  ...
  return (
    <div className="home">
        <div className="home__container">
            <img src="https://png.pngtree.com/thumb_back/fh260/back_our/20190620/ourmid/pngtree-double-eleven-geometric-activity-promotion-clothing-banner-image_174097.jpg" alt="" className="home__image" />
